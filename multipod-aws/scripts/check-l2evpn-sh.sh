...
docker exec multipod-aws-client11 bash -c 'ping -c 4 10.1.1.13'
...
docker exec multipod-aws-client11 bash -c 'ping -c 4 10.1.1.21'
...
docker exec multipod-aws-client11 bash -c 'ping -c 4 10.1.1.23'
...
docker exec multipod-aws-pod1-leaf1 sr_cli 'show network-instance default protocols bgp routes evpn route-type 2 summary'
